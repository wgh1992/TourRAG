...
-- Exported at: 2026-01-17T19:10:52.285573
...
CREATE TABLE viewpoint_ai_summaries (id bigint NOT NULL, viewpoint_id bigint NOT NULL, history_summary text, search_summary text, season_info jsonb, visual_tags jsonb, source character varying NOT NULL, created_at timestamp with time zone, updated_at timestamp with time zone, llm_output jsonb);
